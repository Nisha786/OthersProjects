 ...
 %>
    ...
    <h3>Update Products</h3>
       <form action="CustomerUpdateCtl" method="post" >
           ...
           <tr>
           <th>Customer Name</th>
           <td><input type = "text" name = "cname" id = "cname" value = "<%= request.getParameter("cname")%>"><font id = "p1" color = "red"></font></td>
           </tr>
           <tr>
           <th>Email</th>
           <td><input type = "text" name = "email" id = "email" value = "<%= request.getParameter("email")%>"><font id = "p2" color = "red"></font></td>
           </tr>
           <tr>
           <th>Password</th>
           <td><input type = "text"  name = "pass" id = "pass" value = "<%= request.getParameter("pass")%>"><font id = "p3" color = "red"></font></td>
           </tr>
           <tr>
