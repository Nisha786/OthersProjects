			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div id="show-message"></div>
						<div class="modal-body modal-body-sub_agile">
						<div class="col-md-8 modal_body_left modal_body_left1">
						<h3 class="agileinfo_sign">Sign Up <span>Now  
						                                         </span></h3>
						 <form action="CustomersCtl" method="post" name = "regF">
							...
							<div class="styled-input">
								...
								<label>Email<span id = "isE"></span></label>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<div class="modal-body modal-body-sub_agile">
						<div class="col-md-8 modal_body_left modal_body_left1">
						<h3 class="agileinfo_sign">Choose a Payment Method</h3><hr>
...
<!-- //schedule-bottom -->
  <!-- banner-bootom-w3-agileits -->
		...
		<h3 class="wthree_text_info" style="margin-top: -50px;"><font color='white'>What's <span>Trending</span></font></h3>
 <%
  try{
	  Connection conn = null;
	  conn = JDBCDataSourceSpencerOnline.getConnection();
	  String sql = "select * from homepageimages limit 2";
  ...
  %>
	    <div class="banner-bootom-w3-agileits" style="margin-top: -60px; background-color:#000000;">
	
		<div class="col-md-12 bb-grids bb-left-agileits-w3layouts" style="background-color:#000000;">
			<a href="#">
			   <div class="bb-left-agileits-w3layouts-inner grid">
					<figure class="effect-roxy">
						...
						<img src="upload/upload/<%= filename %>" alt=" " style="margin-left: 115px; class="img-responsive"  background-color:#000000; />
	<%  }
  }catch(Exception e){
	  e.printStackTrace();
  }
...
<!-- banner-bootom-w3-agileits -->
	<div class="banner-bootom-w3-agileits" style="background-color:#000000;">
...
<div class="footer" style="background-color:#000000;">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			<h2 style="font-family: Aleo Light;"><a href="Index.jsp"><span></span><font color='00FFFF'>Spencer</font></a></h2>
				...
				<div class="col-md-5 sign-gd-two">
					...
					<div class="w3-address">
						...
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								<h6>Email Address</h6>
								<p>Email :<a href="#"> info@spencer.com</a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="w3-address-grid">
