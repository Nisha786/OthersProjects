                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                                ...
                                                                <img width="60px" src="upload/upload/<%= request.getParameter("fiename") %>" alt="product">
                                                ...
                                                <div class="panel-group accordion style2" id="accordionPayment" role="tablist" aria-multiselectable="true">
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading" role="tab" id="headingPayment2">
                                                            <h4 class="panel-title">
                                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordionPayment" href="#" aria-expanded="false" aria-controls="collapsePayment2">
