	...
	<div align="center">
		<table border="2">
			...
			<form action="CustomersAdminCtl" method="post">
				<tr>
					<td>Customer Name</td>
					<td><input type="text" name="cname" id="cname"><font
						id="p1" color="red"></font></td>
				</tr>
				<tr>
					<td>Email</td>
					<td><input type="email" name="cemail" id="cemail"><font
						id="p2" color="red"></font></td>
				</tr>
				<tr>
					<td>Contact No</td>
					<td><input type="text" name="contact" id="contact"><font
						id="p4" color="red"></font></td>
				</tr>
				<tr>
					<td>Password</td>
					<td><input type="password" name="cpwd" id="cpwd"><font
						id="p3" color="red"></font></td>
				</tr>
				<tr>
