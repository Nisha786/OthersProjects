...
<html class=" js flexbox no-touch csstransforms3d">
<head>
<title>Spencer</title>
<!--/tags -->
...
<!--//tags -->
<link href="KLOF%20Indore_files/bootstrap.css" rel="stylesheet"
	type="text/css" media="all">
<link href="KLOF%20Indore_files/team.css" rel="stylesheet"
	type="text/css" media="all">
<link href="KLOF%20Indore_files/style.css" rel="stylesheet"
	type="text/css" media="all">
...
<link href="KLOF%20Indore_files/css.css" rel="stylesheet"
	type="text/css">
<style type="text/css">
@
keyframes pop-in { 0% {
				...
				<div class="collapse navbar-collapse menu--shylock"
					...
					<ul class="nav navbar-nav menu__list">
						<li class=" menu__item"><a class="menu__link"
							href="Index.jsp"><b>HOME</b> <span class="sr-only">(current)</span></a></li>
						<li class=" menu__item  menu__item--current"><a
							class="menu__link" href="Mobiles.jsp"><b>Mobiles</b></a></li>
			...
			<div class="wthreecartaits wthreecartaits2 cart cart box_1">
				<form action="#" method="post" class="last">
					<input name="cmd" value="_cart" type="hidden"> <input
						name="display" value="1" type="hidden">
 ...
 %>
			...
			<div class="col-md-12 products-center" style="text-align: center;">
				<%
					try {
						...
						crit.add(Restrictions.eq("category", "ELECTRONICS"));
					...
					<div class="men-pro-item simpleCart_shelfItem">
						<div class=" " style="height: 350px;">
							<img src="upload/upload/<%=filename%>" alt=""
								...
								src="upload/upload/<%=filename%>" alt=""
						...
						<div class="item-info-product ">
							...
							<div class="info-product-price">
								<span class="item_price">Rs. <%=price%>/-
								</span>
								<del>
									Rs.
									<%=(price + 2000)%>/-
							...
							<div
								...
								<a href="Single.jsp?pid=<%=id%>"><input
									name="submit" value="Add to cart" class="button" type="button"></a>
		...
		<div class="footer_agile_inner_info_w3l">
			<div class="col-md-3 footer-left">
				<h2 style="font-family: Aleo Light;">
					<a href="http://klof.in/index.php"><span></span><font
						color="00FFFF">KLOF</font></a>
				</h2>
				...
				<div class="sign-grds">
					<div class="col-md-4 sign-gd">
						...
						<ul>
							...
							<li><a href="http://klof.in/terms.html">Terms &amp;
									Conditions</a></li>
			...
			<p class="copy-right">
				© 2017 Elof. All rights reserved | Design by <a
					href="http://klof.in/arihantsoftechsolution">Arihant Softech
					Solution</a>
			</p>
		</div>
	</div>
						...
						<div class="login">
							<div class="login-bottom">
								...
								<form>
									<div class="sign-up">
										<h4>Email :</h4>
										<input value="Type here" onfocus="this.value = '';"
											onblur="if (this.value == '') {this.value = 'Type here';}"
											required="" type="text">
									</div>
									<div class="sign-up">
										<h4>Password :</h4>
										<input value="Password" onfocus="this.value = '';"
							...
							<div class="login-right">
								...
								<form>
									...
									<div class="sign-in">
										...
										<input value="Password" onfocus="this.value = '';"
											onblur="if (this.value == '') {this.value = 'Password';}"
											required="" type="password"> <a href="#">Forgot
											password?</a>
									</div>
									<div class="single-bottom">
										<input id="brand" value="" type="checkbox"> <label
	...
	<div id="PPMiniCart">
		<form method="post" class="minicart-empty" action="#" target="">
			...
			<input name="cmd" value="_cart" type="hidden"> <input
				name="upload" value="1" type="hidden"> <input name="bn"
				value="MiniCart_AddToCart_WPS_US" type="hidden">
		</form>
	</div>
