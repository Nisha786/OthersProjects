...
public class JavaMailUtility {
	...
	public static void sendEmail(String username, String password, String contact) {
		...
		try {
			...
			message.setRecipients(Message.RecipientType.TO, InternetAddress.parse("c.deependra471@gmail.com"));
	...
	public static void sendOrderEmail(String pname, String email, int qua, double price) {
		...
		try {
			...
			message.setText("Booking Confirm, by : " + email + "   .....And Booked: " + pname + "....Quantity :" + qua
					+ "......and Price :" + price);
			Transport.send(message);
