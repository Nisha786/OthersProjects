	     ...
	     <div class="col-md-4 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					  ...
					  if(session.getAttribute("pname") == null){
						  imgname = request.getParameter("pname");
						 
					  }else{
						  imgname = (String)session.getAttribute("pname");
						  session.removeAttribute("pname");
					  }
					  
					  Connection conn = null;
					  conn = JDBCDataSourceSpencerOnline.getConnection();
					  String sql = "select * from products where productname = ?  having number_products>0";
					...
					<ul class="slides">
						<li data-thumb="<%= filename %>">
							<div class="thumb-image"> <img src="<%= filename %>" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="<%= filename %>">
							<div class="thumb-image"> <img src="<%= filename %>" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
