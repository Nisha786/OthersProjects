		...
		<div class="col-md-12 products-center" style="text-align:center;">
				<%
				 try{
				  ...
				  String sql = "select * from products where category = ? having number_products > 0";
				...
				<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class=" " style="height:350px;">
										<img src="<%= filename %>" alt="" class="pro-image-front">
										<img src="<%= filename %>" alt="" class="pro-image-back">
									...
									<div class="item-info-product ">
										...
										<a href="Single.jsp?pname=<%= productname%>"><input name="submit" value="Add to cart" class="button" type="button"></a>
...
[1] <a href="http://klof.in/mens.php?page=2">2</a> <a href="http://klof.in/mens.php?page=3">3</a> <a href="http://klof.in/mens.php?page=4">4</a> <a href="http://klof.in/mens.php?page=5">5</a> <a href="http://klof.in/mens.php?page=6">6</a> <a href="http://klof.in/mens.php?page=7">7</a> 	
	</div>
</div>	
<!-- //mens -->
